...
w('.followup-box{background:#fff;padding:14px 16px;border-radius:8px;border-left:3px solid #34a853;margin-top:14px}')
w('.followup-box h5{font-size:13px;color:#2e7d32;margin-bottom:10px}')
w('.followup-item{background:#f8f9fa;padding:10px 12px;border-radius:6px;margin-bottom:8px;font-size:12px;line-height:1.6}')
w('.followup-item .fu-date{font-weight:600;color:#1a237e}')
w('.followup-item .fu-topic{font-weight:600;color:#333}')
w('.followup-item .fu-link{color:#1a73e8;text-decoration:none;font-size:11px}')
w('.followup-item .fu-link:hover{text-decoration:underline}')
w('.followup-empty{color:#999;font-size:12px;font-style:italic}')
